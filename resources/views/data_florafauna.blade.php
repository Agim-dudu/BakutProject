    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-md-10">
                ...
                @endif
                <a href="{{route('admin.data_florafauna.create')}}" class="btn btn-success">Tambah Data</a>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">{{ $n }}</th>
                            <td><img style="width: 100px;" src="{{ asset('/') }}storage/app/images/florafauna/img/{{ $florafaunas->gambar }}"></td>
                            <td><img style="width: 100px;" src="{{ asset('/') }}storage/app/images/florafauna/icon/{{ $florafaunas->icon }}"></td>
                            <td>{{ $florafaunas->judul }}</td>
                            <td>{{ $florafaunas->created_at}}</td>
                            <td>
                                <a href="{{route('admin.data_florafauna.edit', $florafaunas->id)}}" class="btn btn-primary mb-3">Edit</a>
                                <form action="{{ route('admin.data_florafauna.destroy', $florafaunas->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
