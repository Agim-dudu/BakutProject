		...
		<div class="container">
			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<h3 class="mb-4 text-center"> <a href="" style="font-weight:bold; color:#259632">Register</a></h3>
	            ...
	            <div class="form-group">
	            	<button type="submit" class="form-control btn btn-primary submit px-3" style="background-color:#ffff ;">Sign In</button>
	            </div>
	          ...
	          <div class="social d-flex text-center">
	          	<a href="{{ route('login.facebook') }}" class="px-2 py-2 mr-md-1 rounded"><span class="ion-logo-facebook mr-2"></span> Facebook</a>
