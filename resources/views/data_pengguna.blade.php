	...
	<section id="content">
		...
		<main>
			...
			<div class="head-title">
				<div class="left">
					<h1 id="transaksi">Data Pengguna</h1>
					<ul class="breadcrumb">
						<li>
							<a href="#">Data</a>
						</li>
					...
					<table>
						<thead>
							<tr>
                                ...
                                <th style="padding: 0 30px 5px 30px;">Foto</th>
                                <th style="padding: 0 30px 5px 30px;">Nama</th>
                                <th style="padding: 0 30px 5px 30px;">Jenis Kelamin</th>
                                <th style="padding: 0 30px 5px 30px;">No Hp</th>
                                <th style="padding: 0 30px 5px 30px;">Email</th>
                                <th style="padding: 0 30px 5px 30px;">Level</th>
                        ...
                        <tr>
                            ...
                            <td style="padding: 0 30px 5px 30px;"><img style="width: 50px;height: 50px;object-fit: cover;border-radius: 50%;" src="{{$user->avatar}}" alt="User Avatar"></td>
                            @elseif($user->avatar && ($user->provider == "google"))
                            <td style="padding: 0 30px 5px 30px;"><img style="width: 50px;height: 50px;object-fit: cover;border-radius: 50%;" src="{{ asset('storage/app/images/avatar/' . $user->avatar) }}" alt="User Avatar"></td>
                            @else
                            <td style="padding: 0 30px 5px 30px;"><img style="width: 50px;height: 50px;object-fit: cover;border-radius: 50%;" src="http://bootdey.com/img/Content/avatar/avatar1.png" alt="defauld"></td>
                            @endif
                            <td style="padding: 0 30px 5px 30px;">{{ $user->name }}</td>
                            <td style="padding: 0 30px 5px 30px;">{{ $user->jenis_kelamin }}</td>
                            <td style="padding: 0 30px 5px 30px;">{{ $user->no_telpon }}</td>
                            <td style="padding: 0 30px 5px 30px;">{{ $user->email }}</td>
                            <td style="padding: 0 30px 5px 30px;">{{ $user->is_admin }}</td>
                            <td style="padding: 0 30px 5px 30px;">
                                <a href="{{route('admin.data_pengguna.edit', $user->id)}}" class="btn1">Edit</a>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th scope="row">{{ $n }}</th>
                            @if (($user->provider != ''))
                            <td><img style="width:100px; border-radius:50%;" src="{{ $user->avatar }}" alt="Google Image"></td>
                            @elseif($user->avatar && ($user->provider == "google"))
                            <td><img style="width:100px; border-radius:50%;" src="{{ asset('storage/app/images/avatar/' . $user->avatar) }}" alt="User Avatar"></td>
                            @else
                            <td><img style="width:100px; border-radius:50%;" src="http://bootdey.com/img/Content/avatar/avatar1.png" alt="defauld"></td>
                            @endif
                            <td>{{ $user->name }}</td>
